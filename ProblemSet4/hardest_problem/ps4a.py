...
def updateHand(hand, word):
    ...
    for letter in word:
        hand_copied[letter] = hand_copied.get(letter,0)-1
    return hand_copied 
    ...
    while sum(hand.values()) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                temp = getWordScore(user_input,n)
...
def playGame(wordList):
    ...
    user_option = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
    
            
    hand_copy = {}
    if user_option == 'n':
        while user_option == 'n':
            initial_hand = dealHand(HAND_SIZE)
            hand_copy = initial_hand.copy() 
            playHand(initial_hand, wordList, HAND_SIZE)
            user_option = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
        while user_option == 'r':  
